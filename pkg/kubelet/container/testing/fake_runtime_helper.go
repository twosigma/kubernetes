...
func (f *FakeRuntimeHelper) GetNodenameForKernel(hostname string, hostDomainName string, setHostnameAsFQDN bool) (string, error) {
	if len(hostDomainName) > 0 && setHostnameAsFQDN {
